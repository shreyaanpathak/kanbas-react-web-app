...
export default function KanbasNavigation() {
  return (
    ...
    bottom-0 top-0 d-none d-md-block bg-black z-2">
      <a href="https://www.northeastern.edu/" id="wd-neu-link" target="_blank" className="list-group-item bg-black border-0 text-center"><img src="images/NU_RGB_Notched-N_motto_RW.png" width="80"></img></a>
